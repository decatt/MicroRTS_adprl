...
parser = argparse.ArgumentParser(description='Adapter-RL')
...
class Agent:
    ...
    def get_sample_actions(self,states, unit_masks):
        ...
        distris = distris + torch.tensor(base_dist, dtype=torch.float32)
...
if __name__ == "__main__":
    ...
    global_steps = 0
    weight = args.weight
    comment = "adp_rl_"+map_name+"_"+str(weight)
    ...
    wandb.init(
        ...
        "temperature_coefficient":1/weight,
        }
    )
